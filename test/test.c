...
int main() {
	...
	EXPECT(3, ({ int i=0; int a = 3; int b; if (a == 1) b = 1; else if (a == 2) b = 2; else if(a == 3) b = 3; else b = 4; b; }));
	EXPECT(50, ({
		int a = 0;
		for (int i = 0;i < 10;i++) {
			for(int j = 0;j < 10;j++) {
	...
	EXPECT(8, ({ int ary[2][2]; ary[0][0]=3; ary[1][0]=5; ary[0][0]+ary[1][0];}));
	...
	EXPECT(4, ({ myint fkkoo = 3; sizeof(fkkoo); }));
